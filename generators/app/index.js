...
const jhipsterVar = { moduleName: 'awsecs' };
...
module.exports = generator.extend({
    ...
    initializing: {
        ...
        displayLogo() {
            ...
            this.log(`Welcome to the ${chalk.bold.yellow('JHipster awsecs')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
        }
    },
    ...
    install() {
        ...
        this.log('End of awsecs generator');
    }
});
